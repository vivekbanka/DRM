...
using drm.Application.TodoItems.Commands.DeleteTodoItem;
using drm.Application.TodoItems.Commands.UpdateTodoItem;
using drm.Application.TodoItems.Commands.UpdateTodoItemDetail;
using drm.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace drm.Web.Endpoints;
